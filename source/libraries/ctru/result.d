...
extern (D) auto R_FAILED(T)(auto ref T res)
{
    return res < 0;
}

/// Returns the level of a result code.
extern (D) auto R_LEVEL(T)(auto ref T res)
{
    return (res >> 27) & 0x1F;
}

/// Returns the summary of a result code.
extern (D) auto R_SUMMARY(T)(auto ref T res)
{
    return (res >> 21) & 0x3F;
}

/// Returns the module ID of a result code.
extern (D) auto R_MODULE(T)(auto ref T res)
{
    return (res >> 10) & 0xFF;
}

/// Returns the description of a result code.
extern (D) auto R_DESCRIPTION(T)(auto ref T res)
{
    return res & 0x3FF;
}
